...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <motion.div className="bg-white rounded-lg shadow-md overflow-hidden" variants={cardVariants} whileHover="hover">
          ...
          <div>
            {isPromotion ? (
              <div className="flex items-center gap-2">
                <span className="text-lg font-bold text-red-500">${product.promotionPrice ? product.promotionPrice.toFixed(2) : 0}</span>
